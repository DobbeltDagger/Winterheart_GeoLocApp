...
const setupMenu = (map) => {
  ...
  document.getElementById("onlineMarkerBtn").addEventListener('click', (e) => {
    e.preventDefault();
    // check if menu overlay is shown
    if (document.getElementById('mobileMenuOverlay').classList.contains("shown") == true) {
...
////////////////////////////////////
// hide the form and show progress -but stay inside the MEDIA OVERLAY!
const showUploadForm = () => {

  document.getElementById("mediaForm").classList.add("formHidden");
  document.getElementById("mediaForm").classList.remove("shown");
  // show uploadWrapper
  document.getElementById("uploadProgressWrapper").classList.add("shown");
  document.getElementById("uploadProgressWrapper").classList.remove("hidden");
